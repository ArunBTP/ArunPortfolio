      ...
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto  animate-fade-in-delay-3">
            I craft cutting-edge digital experiences using the latest technologies, with a strong focus on SAP BTP Cloud Full Stack and modern full-stack web development. My work blends technical precision with intuitive design to deliver solutions that are both powerful and user-friendly.
          </p>
